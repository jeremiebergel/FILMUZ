...
$sql_row4 = "SELECT `id`, `titre`, `image` FROM `filmuz` WHERE `type` = 'sci-fi' LIMIT 4;";
$stmt_row4 = $pdo->prepare($sql_row4);
$stmt_row4->execute();
$sql_row4b = "SELECT `id`, `titre`, `image` FROM `filmuz` WHERE `type` = 'sci-fi' LIMIT 4 OFFSET 4;";
