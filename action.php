...
$sql_row4 = "SELECT `id`, `titre`, `image` FROM `filmuz` WHERE `type` = 'action' LIMIT 4;";
$stmt_row4 = $pdo->prepare($sql_row4);
$stmt_row4->execute();
$sql_row4b = "SELECT `id`, `titre`, `image` FROM `filmuz` WHERE `type` = 'action' LIMIT 4 OFFSET 4;";
...
<head>
    <meta charset="UTF-8">
    <title>filmuz // action</title>
    <link rel="stylesheet" href="css/screen.css">
</head>

<body>
    <header class="header-action clearfix">
        ...
        <nav>
            <ul>
                ...
                <li id="active"><a href="action.php">action</a></li>
            </ul>
        </nav>
