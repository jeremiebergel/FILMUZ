...
$sql_row4 = "SELECT `id`, `titre`, `image` FROM `filmuz` WHERE `type` = 'western' LIMIT 4;";
$stmt_row4 = $pdo->prepare($sql_row4);
$stmt_row4->execute();
$sql_row4b = "SELECT `id`, `titre`, `image` FROM `filmuz` WHERE `type` = 'western' LIMIT 4 OFFSET 4;";
...
<body>
    <header class="header-western clearfix">
        <a href="index.php"><img src="img-layout/logo.png" class="logo" alt="logo"></a>
        <nav>
            <ul>
                <li id="active"><a href="western.php">western</a></li>
